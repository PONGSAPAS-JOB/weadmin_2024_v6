...
for ($i = 1; $i <= $_REQUEST['TotalCheckBoxID']; $i++) {
   ...
   if (strlen($myVar) >= 1) {
      ...
      $sql = "SELECT  " . $mod_tb_root_lang . "_htmlfilename as htmlfilename," . $mod_tb_root_lang . "_htmlfilename2 as htmlfilename2," . $mod_tb_root_lang . "_pic as pic ," . $mod_tb_root_lang . "_pic2 as pic2," . $mod_tb_root_lang . "_filevdo as filevdo," . $mod_tb_root_lang . "_id as id FROM " . $mod_tb_root_lang . " WHERE  " . $mod_tb_root_lang . "_cid='" . $permissionID . "' ";
