...
function delFileUpload2(fileAc) {
...
function delAlbumUpload2(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxAlbumNew2").show();
            jQuery("#boxAlbumNew2").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delVideoUpload2(fileAc) {
...
function submitResetFck2() {
    CKEDITOR.instances.editDetail2.setData("");
}
