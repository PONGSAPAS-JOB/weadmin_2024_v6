...
<?php
	$error = "";
	$msg = "";
	$fileElementName2 = 'inputFileUpload2';
	if(!empty($_FILES['inputFileUpload2']['error'])){
		...
		$error = 'No file was uploaded..';
			...
			$filenamedoc = "file2-".$_REQUEST['myID']."-".$_REQUEST['langt']."-".$myNewRand.".$fileTypeName";
		...
		$insert = array();
		$insert[$mod_tb_fileTemp."_contantid2"] = "'".$_REQUEST['myID']."'";
		$insert[$mod_tb_fileTemp."_filename2"] = "'".$filenamedoc."'";
		...
		$Query=wewebQueryDB($coreLanguageSQL,$sql);	
		 ...
		 $sql="SELECT ".$mod_tb_fileTemp."_id,".$mod_tb_fileTemp."_filename2,".$mod_tb_fileTemp."_name FROM ".$mod_tb_fileTemp." WHERE ".$mod_tb_fileTemp."_contantid2 	='".$_REQUEST['myID']."'   ORDER BY ".$mod_tb_fileTemp."_id ASC";
