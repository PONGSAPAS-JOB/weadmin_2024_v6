...
<meta name="googlebot" content="noindex, nofollow">
  ...
  <link href="../js/jquery-ui-1.9.0.css" rel="stylesheet" >
  <link href="../js/select2/css/select2.css?v=<?php echo date('YmdHis');?>" rel="stylesheet"/>
  <link href="../css/theme-select2.css?v=<?php echo date('YmdHis');?>" rel="stylesheet"/>
<link href="../css/theme.css" rel="stylesheet"/>
<title><?php echo $core_name_title?></title>
<script language="JavaScript"  type="text/javascript" src="../js/jquery-1.9.0.js"></script>
  <script language="JavaScript"  type="text/javascript" src="../js/jquery-ui-1.9.0.js"></script>
  <script language="JavaScript"  type="text/javascript" src="../js/select2/js/select2.js?v=<?php echo date('YmdHis');?>"></script>
...
if($_REQUEST['inputSearch']!="") {
	...
	$sqlSearch = "";
	// Search Status value #########################
	if($_REQUEST['inputStatusName']<>"") {
	  $sqlSearch = $sqlSearch . "  AND " . $mod_tb_root . "_status ='" . $_REQUEST['inputStatusName'] . "'   ";
	 }
...
<input name="module_orderby" type="hidden" id="module_orderby" value="<?php echo $module_orderby?>" />
          ...
          <select name="inputStatusName" id="inputStatusName" onchange="document.myForm.submit(); " class="formSelectSearchStyle select2" style="margin-top: 10px;">
              <option value=""><?php echo $langMod["dev2409:status"];?></option>
              <?php
             foreach ($modTxtStatusName as $valueStatusName) {
              ?>
                <option value="<?php echo $valueStatusName ?>" <?php if ($_REQUEST['inputStatusName'] == $valueStatusName) { ?> selected="selected" <?php  } ?>><?php echo $valueStatusName ?></option>
              <?php } ?>
            </select></td>
					<td   id="boxSelectTest"  class="textSearch2">
  <input name="inputSearch" type="text"  id="inputSearch" value="<?php echo trim($_REQUEST['inputSearch'])?>" class="formInputSearchStyle formInputSearchStyleSelect2"  placeholder="<?php echo $langMod["dev2409:keyword"]?>" /></td>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center"   class="tbBoxListwBorder">
  ...
  <?php
// SQL SELECT #########################
$sql = "SELECT ".$mod_tb_root."_id,".$mod_tb_root."_subject,".$mod_tb_root."_lastdate,".$mod_tb_root."_status,".$mod_tb_root."_subjecten,".$mod_tb_root."_pic,".$mod_tb_root."_view,".$mod_tb_root."_ribbon ,".$mod_tb_root."_pin   ,".$mod_tb_root."_gid   FROM ".$mod_tb_root;
