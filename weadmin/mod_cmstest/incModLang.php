...
$langMod["tit:inpName"] = "Name " .getNameMenu($_REQUEST["menukeyid"]);
    ...
    $langMod["viw:subjectgDe"] = "ข้อมูลชื่อ" . $langMod["meu:group"] . " เพื่อใช้ในการแสดงผลในหน้าเว็บไซต์ของคุณ";
		...
		$langMod["tit:groupType2"] = "ประเภทรายละเอียด 2 ";
		...
		$langMod["tit:subject2"] ="ชื่อ".getNameMenu($_REQUEST["menukeyid"])." 2";
		...
		$langMod["tit:title2"] ="คำบรรยาย 2";
		$langMod["tit:typevdo"] ="ประเภทวิดีโอ";
		$langMod["tit:linkvdo"] ="ลิงค์ URL";
		$langMod["tit:linkvdo2"] ="ลิงค์ URL 2";
		$langMod["tit:uploadpic1"] ="อัพโหลดรูปภาพ 1";
		$langMod["tit:uploadpic2"] ="อัพโหลดรูปภาพ 2";
...
$langMod["txt:upcoming"] = "Pin Contant"; 
		...
		$langMod["dev2409:status"]= "เลือกสถานะ";
		$langMod["dev2409:keyword"]= "คำค้นหา";
