...
<?php
	...
	if(!empty($_FILES['inputFileUpload2']['error'])){
		...
		$error = 'No file was uploaded..';
			...
			$filenamedoc = "file2-".$_REQUEST['myID']."-".$_REQUEST['langt']."-$myrand.$fileTypeName";
		...
		$insert = array();
		$insert[$mod_tb_file."_contantid2"] = "'".$_REQUEST['myID']."'";
		$insert[$mod_tb_file."_filename2"] = "'".$filenamedoc."'";
		...
		$sql="SELECT ".$mod_tb_file."_id,".$mod_tb_file."_filename2,".$mod_tb_file."_name,".$mod_tb_file."_download FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_contantid2 	='".$_REQUEST['myID']."'   ORDER BY ".$mod_tb_file."_id ASC";
