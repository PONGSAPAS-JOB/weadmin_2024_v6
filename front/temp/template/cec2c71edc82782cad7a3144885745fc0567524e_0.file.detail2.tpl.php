<?php
/* Smarty version 4.3.2, created on 2025-01-08 14:54:44
  from '/var/www/html/weadmin_2024_v5/front/controller/script/new/template/detail2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_677e2f44737445_35306287',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cec2c71edc82782cad7a3144885745fc0567524e' => 
    array (
      0 => '/var/www/html/weadmin_2024_v5/front/controller/script/new/template/detail2.tpl',
      1 => 1736322882,
      2 => 'file',
    ),
  ),
...
function content_677e2f44737445_35306287 (Smarty_Internal_Template $_smarty_tpl) {
...
/new" class="link" title="ข่าวสาร">
                            ...
                            <li class="active">
                                Detail 2 / <?php echo $_smarty_tpl->tpl_vars['callCms']->value->fields['subject2'];?>
                    ...
                    <div style="display: flex;">
                        ...
                        <div class="col-auto">
                            <div class="back-to-previous">
                                <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/new/detail/<?php echo $_smarty_tpl->tpl_vars['callCms']->value->fields['id'];?>
    ...
    <div class="default-body">
        <div class="home-content news-detail">
            ...
            <div class="gallery-detail">
                <div class="container">
                    <?php if ($_smarty_tpl->tpl_vars['call_news_album2']->value->_numOfRows >= 1) {?>
                        <div class="gallery-detail-list" style="display: flex;">
                            <div class="slider slider-single">
                                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['call_news_album2']->value, 'valuecall_news_album2', false, 'keycall_news_album2');
$_smarty_tpl->tpl_vars['valuecall_news_album2']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['keycall_news_album2']->value => $_smarty_tpl->tpl_vars['valuecall_news_album2']->value) {
$_smarty_tpl->tpl_vars['valuecall_news_album2']->do_else = false;
?>
                                    <div class="item">
                                        <a href="<?php ob_start();
echo $_smarty_tpl->tpl_vars['callCms']->value->fields['masterkey'];
$_prefixVariable1 = ob_get_clean();
echo fileinclude($_smarty_tpl->tpl_vars['valuecall_news_album2']->value['filename2'],'album',$_prefixVariable1,'link');?>
"
...
echo fileinclude($_smarty_tpl->tpl_vars['valuecall_news_album2']->value['filename2'],'album',$_prefixVariable2,'link');?>
"
                                                        alt="img <?php echo $_smarty_tpl->tpl_vars['keycall_news_album2']->value;?>
">
                                                </div>
                                            </div>
                                        </a>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php }?>
                    <div class="desc mt-5">
                        <h1>2 : <?php echo $_smarty_tpl->tpl_vars['callCms']->value->fields['subject2'];?>
</h1>
                        <p>2 :<?php echo $_smarty_tpl->tpl_vars['callCms']->value->fields['title2'];?>
</p>

                    </div>
                    </br>

                    <?php if (($_smarty_tpl->tpl_vars['callCms']->value->fields['url2'] != '' && $_smarty_tpl->tpl_vars['callCms']->value->fields['url2'] != '#') || $_smarty_tpl->tpl_vars['callCms']->value->fields['filevdo2'] != '') {?>
                        <hr>
                    <?php }?>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="whead-addon">
                                <div class="detail-info">
                                    <ul class="item-list">
                                        <li><?php echo DateThai($_smarty_tpl->tpl_vars['callCms']->value->fields['credate2'],23,"en","shot3");?>
 </li>
                                        <li class="ml-2">
...
/assets/img/icon/icon-twitter-B.svg" alt="Twitter this post">
                ...
                <hr>
                <div class="news" style="background-color: #fffbae;">
                    <div class="container">
                        
                        <?php if ($_smarty_tpl->tpl_vars['callCms']->value->_numOfRows >= 1) {?>
                                                        <h1>HTML 2 :<?php echo $_smarty_tpl->tpl_vars['callCms']->value->fields['subject2'];?>
</h1>
                            <div class="detail">
...
echo callHtml(fileinclude($_smarty_tpl->tpl_vars['callCms']->value->fields['htmlfilename2'],"html",$_prefixVariable3));?>
                        ...
                        <div class="main-slider" data-aos="fade-up">
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['callCms']->value->fields['type2'] == 'url') {?>
                                    <?php $_smarty_tpl->_assignInScope('myUrlArray', smarty_modifier_explode("v=",$_smarty_tpl->tpl_vars['callCms']->value->fields['url2']));?>
...
" title="YouTube video player"
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['callCms']->value->fields['type2'] == 'file') {?>
...
echo fileinclude($_smarty_tpl->tpl_vars['callCms']->value->fields['filevdo2'],'vdo',$_prefixVariable4,'vdo');?>
"
                                                        type="video/mp4">
                ...
                <hr>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['Call_FileDownload2']->value->_numOfRows >= 1) {?>
                    <div class="document-downloads">
                        ...
                        <div class="container">
                            <div class="download-slider" data-aos="fade-up">
                                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['Call_FileDownload2']->value, 'Value_Call_FileDownload2', false, 'Key_Call_FileDownload2');
$_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['Key_Call_FileDownload2']->value => $_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value) {
$_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->do_else = false;
?>
                                    <?php ob_start();
echo $_smarty_tpl->tpl_vars['callCms']->value->fields['masterkey'];
$_prefixVariable5 = ob_get_clean();
$_smarty_tpl->_assignInScope('fileinfo', get_Icon(fileinclude($_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['filename2'],'file',$_prefixVariable5)));?>
                                    <div class="item">
                                        <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/download2/<?php ob_start();
echo $_smarty_tpl->tpl_vars['callCms']->value->fields['masterkey'];
$_prefixVariable6 = ob_get_clean();
echo fileinclude($_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['filename2'],'file',$_prefixVariable6,'download');?>
&n=<?php echo $_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['name'];?>
...
/assets/img/icon/icon-downloads.svg"
                                                            ...
                                                            <div class="col">
                                                                <div class="title">
                                                                    <?php echo $_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['name'];?>
...
echo get_IconSize(fileinclude($_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['filename2'],'file',$_prefixVariable7));?>
                                                                ...
                                                                <div class="typo-xs">จำนวนดาวน์โหลด/ Download :
                                                                    <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['Value_Call_FileDownload2']->value['download']);?>
</div>
                                                            </div>
                                                            <div class="col-auto">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <?php }?>
                        ...
                        <hr>
            <?php if ($_smarty_tpl->tpl_vars['nextCms2']->value || $_smarty_tpl->tpl_vars['previousCms2']->value) {?>
                <div class="action -back-2-previous">
                   <div class="row action-top">
                      <div class="col-auto">
                         <?php if ($_smarty_tpl->tpl_vars['nextCms2']->value) {?>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/new/detail2/<?php echo $_smarty_tpl->tpl_vars['nextCms2']->value['id'];?>
" class="btn btn-lg btn-light">
                      ...
                      <div class="col-auto">
                         <?php if ($_smarty_tpl->tpl_vars['previousCms2']->value) {?>
                               <a href="<?php echo $_smarty_tpl->tpl_vars['ul']->value;?>
/new/detail2/<?php echo $_smarty_tpl->tpl_vars['previousCms2']->value['id'];?>
" class="btn btn-lg btn-light">
                                  ย้อนกลับ
