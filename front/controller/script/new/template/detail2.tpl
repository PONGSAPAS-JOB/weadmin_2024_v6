                ...
                <div class="row align-items-center no-gutters">
                    <div class="col">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                Detail 2 / {$callCms->fields.subject2}
                            </li>
                        </ol>
                    </div>
                    <div style="display: flex;">
                        ...
                        <div class="col-auto">
                            <div class="back-to-previous">
                                <a href="{$ul}/new/detail/{$callCms->fields.id}" title="Detail 2" class="link"
    ...
    <div class="default-body">
        <div class="home-content news-detail">
            ...
            <div class="gallery-detail">
                <div class="container">
                    {if $call_news_album2->_numOfRows gte 1}
                        <div class="gallery-detail-list" style="display: flex;">
                            <div class="slider slider-single">
                                {foreach $call_news_album2 as $keycall_news_album2 => $valuecall_news_album2}
                                    <div class="item">
                                        <a href="{$valuecall_news_album2.filename2|fileinclude:'album':{$callCms->fields.masterkey}:'link'}"
                                            class="link" data-fancybox="gallery-detail">
                                            <div class="image">
                                                <div class="cover">
                                                    <img class="lazy" style="width: 100px; hight: 100px; display: flex;"
                                                        src="{$valuecall_news_album2.filename2|fileinclude:'album':{$callCms->fields.masterkey}:'link'}"
                                                        alt="img {$keycall_news_album2}">
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                    ...
                    {/if}
                    <div class="desc mt-5">
                        <h1>2 : {$callCms->fields.subject2}</h1>
                        <p>2 :{$callCms->fields.title2}</p>

                    </div>
                    </br>

                    {if ($callCms->fields['url2'] neq '' && $callCms->fields['url2'] neq '#') || $callCms->fields.filevdo2 != ''}
                        <hr>
                    {/if}
                </div>
            </div>
            ...
            <div class="default-bar">
                        ...
                        <div class="col">
                            <div class="whead-addon">
                                <div class="detail-info">
                                    <ul class="item-list">
                                        <li>{$callCms->fields['credate2']|DateThai:23:"en":"shot3"} </li>
                                        <li class="ml-2">
                ...
                <div class="news" style="background-color: #fffbae;">
                    <div class="container">
                        ...
                        {if $callCms->_numOfRows gte 1}
                            {*//* start detail */*}
                            <h1>HTML 2 :{$callCms->fields.subject2}</h1>
                            <div class="detail">

                                        {strip}
                                    {$callCms->fields['htmlfilename2']|fileinclude:"html":{$callCms->fields['masterkey']}|callHtml}
                        ...
                        <div class="main-slider" data-aos="fade-up">
                                        ...
                                        {if $callCms->fields['type2'] eq 'url'}
                                    {$myUrlArray = "v="|explode:$callCms->fields['url2']}
                                    ...
                                    <div class="detail-vdo">
                                        ...
                                        {if $callCms->fields['type2'] eq 'file'}
                                    <div class="item video">
                                        <a>
                                            <div class="video-container">
                                                <video class="slide-video slide-media" width="100%" loop autoplay muted>
                                                    <source
                                                        src="{$callCms->fields['filevdo2']|fileinclude:'vdo':{$callCms->fields['masterkey']}:'vdo'}"
                                                        type="video/mp4">
                ...
                <hr>
                    ...
                    {if $Call_FileDownload2->_numOfRows gte 1}
                    <div class="document-downloads">
                        ...
                        <div class="container">
                            <div class="download-slider" data-aos="fade-up">
                                        {foreach $Call_FileDownload2 as $Key_Call_FileDownload2 => $Value_Call_FileDownload2}
                                    {$fileinfo = $Value_Call_FileDownload2['filename2']|fileinclude:'file':{$callCms->fields.masterkey}|get_Icon}
                                    <div class="item">
                                        <a href="{$ul}/download2/{$Value_Call_FileDownload2['filename2']|fileinclude:'file':{$callCms->fields['masterkey']}:'download'}&n={$Value_Call_FileDownload2['name']}&t={'md_cmf'|encodeStr}"
                                            class="link report">
                                            <div class="wrapper">
                                                        ...
                                                        <div class="row align-items-center pt-3">
                                                            <div class="col">
                                                                <div class="typo-xs">ขนาด/ Size :
                                                                    {$Value_Call_FileDownload2['filename2']|fileinclude:'file':{$callCms->fields.masterkey}|get_IconSize}
                                                                </div>
                                                                <div class="typo-xs">ประเภทไฟล์/ Type : {$fileinfo.type}</div>
                                                                <div class="typo-xs">จำนวนดาวน์โหลด/ Download :
                                                                    {$Value_Call_FileDownload2.download|number_format}</div>
                                                            </div>
                                                            <div class="col-auto">
            ...
            {* ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// *}
            <hr>
            {if $nextCms2 || $previousCms2}
                <div class="action -back-2-previous">
                   <div class="row action-top">
                      <div class="col-auto">
                         {if $nextCms2}
                            <a href="{$ul}/new/detail2/{$nextCms2.id}" class="btn btn-lg btn-light">
                      ...
                      <div class="col-auto">
                         {if $previousCms2}
                               <a href="{$ul}/new/detail2/{$previousCms2.id}" class="btn btn-lg btn-light">
                                  ย้อนกลับ
